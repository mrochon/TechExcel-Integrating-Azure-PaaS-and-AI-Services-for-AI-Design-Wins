...
namespace ContosoSuitesWebAPI.Services
{
    ...
    /// </summary>
    public class VectorizationService(/*AzureOpenAIClient openAIClient*/ Kernel kernel, CosmosClient cosmosClient, IConfiguration configuration) : IVectorizationService
    {
